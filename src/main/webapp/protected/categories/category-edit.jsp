		...
		<div class="container row-fluid">
			<div class="col-lg-12 Margin_0 Padding_0">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><i class="fa fa-file"></i> Category Editing</li>
				</ol>
			</div>
		</div>
		<!-- /.row -->
		...
		<div class="row-fluid">
				...
				<div class="container" ng-controller="categoriesController">
					<div class="col-lg-12 BgWhiteGri Padding_10 MarginBottom_10">
						<div ng-init="selectCategory('${selectedCategoryId}')">
							<form class="form-horizontal " role="form" name="updateCategoryForm"
								novalidate>
								...
								<div class="form-group">
									...
									<div class="col-lg-9 col-md-9 col-sm-9 PaddingRight_0">
										<input type="text" class="form-control" id="categoryName" required="required"
											ng-model="selectedCategory.categoryName" name="categoryName" placeholder="Required" />
									</div>
								<div class="MarginTop_5">
									 <span class="alert alert-danger Padding_5" 
										ng-show="displayValidationError && updateCategoryForm.categoryName.$error.required">
							...
							<div class="form-group">
								...
								<div class="col-lg-9 col-md-9 col-sm-9 PaddingRight_0">
									<input type="submit" ng-click="updateCategory(updateCategoryForm)"
