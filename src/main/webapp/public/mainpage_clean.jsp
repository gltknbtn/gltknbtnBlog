...
<div class="row-fluid" ng-controller="mainpageController">
	...
	<!-- Category -->
	<div class="col-lg-2 col-lg-offset-2 col-md-4 col-sm-4 MarginTop_20">
		<div class="list-group">

			<a href=""
				ng-click="getArticleListFirstPageByCategoryName('AllCategory')"
				class="list-group-item"
				ng-class="{'active': selectedCategoryName == 'AllCategory', '': selectedCategoryName != 'AllCategory'}">All
				Category <span class="badge">{{totalArticleSize}}</span>
			</a> 
			<a href=""
				ng-click="getArticleListFirstPageByCategoryName(category.categoryName)"
				class="list-group-item"
				ng-class="{'active': selectedCategoryName == category.categoryName, '': selectedCategoryName != category.categoryName}"
				ng-repeat="category in categories">{{category.categoryName}} <span
				class="badge">{{category.articleCount}}</span>
			</a>
		...
		<div class="row" ng-repeat="article in page.source">
			<div class="col-lg-8 col-md-10">
				<div class="post-preview">
					...
					<p class="post-meta">
						Posted by <a href="#">{{article.userName}}</a> on
						{{article.createdDate}}
					</p>
				</div>
				<hr class="Margin_0">
