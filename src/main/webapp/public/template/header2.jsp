...
<div id="MyMenu" class="navbar navbar-inverse navbar-static-top">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="mainpage" class="navbar-brand">GltknBtn</a>
                        ...
                        <div class="collapse navbar-collapse navbarSec">
                            <ul class="nav navbar-nav navbar-right"  ng-controller="LocationController">
                                <li ng-class="{'active': activeURL == 'mainpage', '': activeURL != 'mainpage'}"><a href="mainpage">Anasayfa</a></li>
                                <li ng-class="{'active': activeURL == 'aboutme', '': activeURL != 'aboutme'}"><a href="aboutme">Hakkımda</a></li>
                            <!--     <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Dersler <b class="caret"></b></a>
                                ...
                                <li ng-class="{'active': activeURL == 'contactme', '': activeURL != 'contactme'}"><a href="contactme">İletişim</a></li>
